...
import (
	...
	"gorm.io/gorm/logger"
	"log"
	common "markasbali_go_final_project/cli-service/modules/common/models"
	"markasbali_go_final_project/cli-service/modules/reset/models"
	"os"
	"strconv"
	"sync"
)
...
func ImportBook() error {
	...
	file, err := os.Open("cli-service/modules/reset/seeders/books.csv")
...
func ImportCar() error {
	...
	file, err := os.Open("cli-service/modules/reset/seeders/cars_500.csv")
...
func OpenDB(silentLogger bool, conn common.MySqlConn) {
